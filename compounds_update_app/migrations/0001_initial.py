# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-11-18 20:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('n_cas', models.CharField(blank=True, help_text='Ejemplo: 234-4-56', max_length=150, null=True)),
        ...
        migrations.CreateModel(
            name='SinonimosUpdate',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sinonimo', models.CharField(max_length=150)),
                ('reactivo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sinonimos', to='compounds_update_app.ReactivoUpdate')),
            ],
        ),
        migrations.CreateModel(
            name='UserInfo',
        ...
        migrations.AddField(
            ...
            name='reactivo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='compounds_update_app.ReactivoUpdate'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='existencia',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='compounds_update_app.ExistenciaUpdate'),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='sinonimosupdate',
            unique_together=set([('reactivo', 'sinonimo')]),
        ),
        migrations.AlterUniqueTogether(
            name='existenciaupdate',
